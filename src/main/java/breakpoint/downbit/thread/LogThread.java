package breakpoint.downbit.thread;

import breakpoint.downbit.DownloadMain;
...
public class LogThread implements Callable<Boolean> {
    ...
    public static AtomicLong LOCAL_FINISH_SIZE = new AtomicLong(); //下载开始前本地已经下载的字节数
    public static AtomicLong DOWNLOAD_SIZE = new AtomicLong(); //下载开始后的下载字节数
    public static AtomicLong DOWNLOAD_FINISH_THREAD = new AtomicLong(); //完成下载的线程数
